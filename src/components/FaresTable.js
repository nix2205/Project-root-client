...
//   newRow,
//   onChangeNewRow,
//   onDeleteRow, // ✅ ACCEPT the new prop
...
//                   // This part for HQ city with no transport remains the same
//                   return (
...
//                           </div>
//                         ) : (
//                           // ✅ ADDED a div and the Delete button
//                           <div className="flex gap-2">
//                             <button
//                               className="bg-blue-900 text-white px-3 py-1 rounded hover:bg-blue-600"
...
//             value={newRow.fare}
//             onChange={(e) =>
//               onChangeNewRow({ ...newRow, fare: e.target.value })
//             }
//             className="border rounded px-2 py-2"
//           />
//           <input
