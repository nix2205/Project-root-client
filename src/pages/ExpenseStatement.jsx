...
//   const isSubmitDisabled = isMonthSubmitted || isCurrentMonth;
...
//   if (isCurrentMonth) {
//       alert("You can submit expenses only for previous months.");
//       return;
//     }
...
//       (m) =>
//         m.month === monthKey ||
//         (typeof m.month === "string" && m.month.startsWith(monthKey))
//     );
//   })();
...
//   const handleSubmitForApproval = async () => {
//     if (isCurrentMonth) {
//       alert("You can submit expenses only after the month is completed.");
//       return;
//     }
...
//     if (
//       !window.confirm(
//         `Submit expenses for ${currentMonthLabel} for approval?`
//       )
//     )
//       return;
...
//       await axios.post(
//         `${API}/api/user/submit-month`,
//         { month: selectedMonth, total: grandTotal },
//         { headers }
//       );
